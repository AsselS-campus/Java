...
public class Game {
    ...
    public void jouerUnTour(Personnage perso) throws PersonnageHorsPlateauException, JoueurMortException {
    ...
    public static void fight(Personnage personnage, Ennemi ennemi) throws JoueurMortException {
